...
const Project = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute z-[1] top-4 right-4 flex items-center space-x-4">
        ...
        <div className="absolute z-[1] bottom-4 right-4 flex items-center space-x-4">
        ...
        {showPhone ? null : <div className="show-interface"><Content/></div>}

        {showPhone && 
          <div className={`absolute top-0 left-0 h-full w-full z-0 flex items-center justify-center show-interface`}>
            <div className="w-[276px] h-[597px] bg-white rounded-2xl relative border border-plum-3 shadow-2xl shadow-plum-5 hover:shadow-plum-3 scale-[102%] hover:scale-100 transition-mid overflow-scroll scrollbar-none">
